Dieses git soll als Resourcen sammlung für den Easter Hegg 2017 WebPentesting Workshop dienen.
...
1. Needed Components
  Kali Linux
  Diese Linux Distribution stellt alle benötigten Tools die ich wärend der Demo verwende zur verfügung.
